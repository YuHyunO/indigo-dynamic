...
/**
 * Database Procedure 호출 쿼리를 실행한다.<br>
 * 실행할 쿼리는 Mapper xml 파일에 등록이 되어있어야한다.
 * <br>
 * <br>
 * *<b>Input</b>: 프로시저 호출 시 사용할 파라미터<br>
 * *<b>Input type</b>: {@code Map<String, Object>}
 * <br>
 * <br>
 * *<b>Output</b>: 프로시저 호출 결과<br>
 * *<b>Output type</b>: {@code List<Map<String, Object>>}
 * <br>
 * <br>
...
public class CallProcedure extends ParameterAssignableService implements Serializable {
    ...
    /**
     * {@code CallProcedure} service 가 사용할 queryId를 등록한다.<br>
