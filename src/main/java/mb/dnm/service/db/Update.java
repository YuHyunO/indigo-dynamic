...
/**
 * Input으로 받은 데이터를 파라미터로 하여 UPDATE query를 처리한다.
 * <br>
...
@Slf4j
@Setter
public class Update extends ParameterAssignableService {
